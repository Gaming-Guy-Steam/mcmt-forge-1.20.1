...
@MethodFactory(
   target = TileEntityTeleporter.class
)
public class TileEntityTeleporter$ComputerHandler extends ComputerMethodFactory<TileEntityTeleporter> {
   ...
   public TileEntityTeleporter$ComputerHandler() {
      this.register(
         MethodData.builder("getEnergyItem", TileEntityTeleporter$ComputerHandler::energySlot$getEnergyItem)
            .returnType(ItemStack.class)
            .methodDescription("Get the contents of the energy slot.")
      );
      this.register(
         MethodData.builder("getFrequencies", TileEntityTeleporter$ComputerHandler::getFrequencies_0)
            .returnType(Collection.class)
            .returnExtra(TeleporterFrequency.class)
            .methodDescription("Lists public frequencies")
      );
      this.register(MethodData.builder("hasFrequency", TileEntityTeleporter$ComputerHandler::hasFrequency_0).returnType(boolean.class));
      this.register(
         MethodData.builder("getFrequency", TileEntityTeleporter$ComputerHandler::getFrequency_0)
            .returnType(TeleporterFrequency.class)
            .methodDescription("Requires a frequency to be selected")
      );
      this.register(
         MethodData.builder("setFrequency", TileEntityTeleporter$ComputerHandler::setFrequency_1)
      ...
      this.register(
         MethodData.builder("createFrequency", TileEntityTeleporter$ComputerHandler::createFrequency_1)
            .methodDescription(
      ...
      this.register(
         MethodData.builder("getFrequencyColor", TileEntityTeleporter$ComputerHandler::getFrequencyColor_0)
            .returnType(EnumColor.class)
            .methodDescription("Requires a frequency to be selected")
      );
      this.register(
         MethodData.builder("setFrequencyColor", TileEntityTeleporter$ComputerHandler::setFrequencyColor_1)
            .methodDescription("Requires a frequency to be selected")
            .requiresPublicSecurity()
            .arguments(this.NAMES_color, this.TYPES_88e2323f)
      );
      this.register(
         MethodData.builder("incrementFrequencyColor", TileEntityTeleporter$ComputerHandler::incrementFrequencyColor_0)
            .methodDescription("Requires a frequency to be selected")
            .requiresPublicSecurity()
      );
      this.register(
         MethodData.builder("decrementFrequencyColor", TileEntityTeleporter$ComputerHandler::decrementFrequencyColor_0)
            .methodDescription("Requires a frequency to be selected")
            .requiresPublicSecurity()
      );
      this.register(
         MethodData.builder("getActiveTeleporters", TileEntityTeleporter$ComputerHandler::getActiveTeleporters_0)
            .returnType(Set.class)
            .returnExtra(Coord4D.class)
            .methodDescription("Requires a frequency to be selected")
      );
