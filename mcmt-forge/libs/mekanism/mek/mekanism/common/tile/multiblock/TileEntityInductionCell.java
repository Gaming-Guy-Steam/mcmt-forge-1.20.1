...
public class TileEntityInductionCell extends TileEntityInternalMultiblock {
   ...
   protected IEnergyContainerHolder getInitialEnergyContainers(IContentsListener listener) {
      ...
      builder.addContainer(this.energyContainer = MachineEnergyContainer.internal(this, listener));
   ...
   protected void presetVariables() {
      ...
      this.tier = Attribute.getTier(this.getBlockType(), InductionCellTier.class);
   }
