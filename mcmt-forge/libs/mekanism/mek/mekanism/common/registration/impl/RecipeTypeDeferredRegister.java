...
public class RecipeTypeDeferredRegister extends WrappedDeferredRegister<RecipeType<?>> {
   ...
   public <RECIPE extends MekanismRecipe, INPUT_CACHE extends IInputRecipeCache> RecipeTypeRegistryObject<RECIPE, INPUT_CACHE> register(
      String name, Supplier<? extends MekanismRecipeType<RECIPE, INPUT_CACHE>> sup
   ) {
      RecipeTypeRegistryObject<RECIPE, INPUT_CACHE> registeredRecipeType = this.register(name, sup, RecipeTypeRegistryObject::new);
