...
public class BlockDeferredRegister extends DoubleDeferredRegister<Block, Item> {
   ...
   public BlockRegistryObject<Block, BlockItem> register(String name, net.minecraft.world.level.block.state.BlockBehaviour.Properties properties) {
      return this.registerDefaultProperties(name, () -> new Block(BlockStateHelper.applyLightLevelAdjustments(properties)), BlockItem::new);
   }
   ...
   public <BLOCK extends Block, ITEM extends BlockItem> BlockRegistryObject<BLOCK, ITEM> registerDefaultProperties(
      String name, Supplier<? extends BLOCK> blockSupplier, BiFunction<BLOCK, Properties, ITEM> itemCreator
   ) {
      return this.register(name, blockSupplier, block -> itemCreator.apply(block, new Properties()));
   }
   ...
   public <BLOCK extends Block, ITEM extends BlockItem> BlockRegistryObject<BLOCK, ITEM> register(
      ...
      BlockRegistryObject<BLOCK, ITEM> registeredBlock = this.register(name, blockSupplier, itemCreator, BlockRegistryObject::new);
