...
public class ChemicalTankUpgradeData implements IUpgradeData {
   ...
   public final TileEntityChemicalTank.GasMode dumping;
   ...
   public ChemicalTankUpgradeData(
      boolean redstone,
      ...
      TileEntityChemicalTank.GasMode dumping,
      GasStack storedGas,
      InfusionStack storedInfusion,
      PigmentStack storedPigment,
      SlurryStack storedSlurry,
