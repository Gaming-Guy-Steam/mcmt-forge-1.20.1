...
public class PigmentStackIngredientCreator extends ChemicalStackIngredientCreator<Pigment, PigmentStack, ChemicalStackIngredient.PigmentStackIngredient> {
   ...
   public ChemicalStackIngredient.PigmentStackIngredient from(IChemicalProvider<Pigment> provider, long amount) {
      ...
      return new PigmentStackIngredientCreator.SinglePigmentStackIngredient(pigment.getStack(amount));
   }
   ...
   public ChemicalStackIngredient.PigmentStackIngredient from(TagKey<Pigment> tag, long amount) {
      ...
      this.assertPositiveAmount(amount);
      return new PigmentStackIngredientCreator.TaggedPigmentStackIngredient(tag, amount);
   }
   ...
   public ChemicalStackIngredient.PigmentStackIngredient from(Stream<ChemicalStackIngredient.PigmentStackIngredient> ingredients) {
      return this.createMulti(ingredients.toArray(ChemicalStackIngredient.PigmentStackIngredient[]::new));
   }
