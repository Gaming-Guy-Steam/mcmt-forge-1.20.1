...
public class EnrichingIRecipe extends ItemStackToItemStackRecipe {
   ...
   public RecipeType<ItemStackToItemStackRecipe> m_6671_() {
      return (RecipeType<ItemStackToItemStackRecipe>)MekanismRecipeType.ENRICHING.get();
   }

   public RecipeSerializer<ItemStackToItemStackRecipe> m_7707_() {
      return (RecipeSerializer<ItemStackToItemStackRecipe>)MekanismRecipeSerializers.ENRICHING.get();
   }
