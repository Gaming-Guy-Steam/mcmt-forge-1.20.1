...
public class SmeltingIRecipe extends ItemStackToItemStackRecipe {
   ...
   public RecipeType<ItemStackToItemStackRecipe> m_6671_() {
      return (RecipeType<ItemStackToItemStackRecipe>)MekanismRecipeType.SMELTING.get();
   }

   public RecipeSerializer<ItemStackToItemStackRecipe> m_7707_() {
      return (RecipeSerializer<ItemStackToItemStackRecipe>)MekanismRecipeSerializers.SMELTING.get();
   }
