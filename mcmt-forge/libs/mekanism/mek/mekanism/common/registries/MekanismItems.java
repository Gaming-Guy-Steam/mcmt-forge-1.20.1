...
public class MekanismItems {
   ...
   public static final ItemRegistryObject<ItemEnergized> ENERGY_TABLET = ITEMS.register(
      "energy_tablet",
      (Supplier<? extends ItemEnergized>)(() -> new ItemEnergized(
         MekanismConfig.gear.tabletChargeRate,
         MekanismConfig.gear.tabletMaxEnergy,
         BasicEnergyContainer.alwaysTrue,
         BasicEnergyContainer.alwaysTrue,
         new Properties().m_41497_(Rarity.UNCOMMON)
      ))
   );
   ...
   public static final ItemRegistryObject<ItemPortableQIODashboard> PORTABLE_QIO_DASHBOARD = ITEMS.register(
      "portable_qio_dashboard", ItemPortableQIODashboard::new
   );
   ...
   public static final ItemRegistryObject<ItemHDPEElytra> HDPE_REINFORCED_ELYTRA = ITEMS.register(
      "hdpe_elytra", (Function)(props -> new ItemHDPEElytra(props.m_41503_(648).m_41497_(Rarity.RARE)))
   );
   public static final ItemRegistryObject<ItemHazmatSuitArmor> HAZMAT_MASK = ITEMS.register(
      "hazmat_mask", (Function)(props -> new ItemHazmatSuitArmor(Type.HELMET, props))
   );
   public static final ItemRegistryObject<ItemHazmatSuitArmor> HAZMAT_GOWN = ITEMS.register(
      "hazmat_gown", (Function)(props -> new ItemHazmatSuitArmor(Type.CHESTPLATE, props))
   );
   public static final ItemRegistryObject<ItemHazmatSuitArmor> HAZMAT_PANTS = ITEMS.register(
      "hazmat_pants", (Function)(props -> new ItemHazmatSuitArmor(Type.LEGGINGS, props))
   );
   public static final ItemRegistryObject<ItemHazmatSuitArmor> HAZMAT_BOOTS = ITEMS.register(
      "hazmat_boots", (Function)(props -> new ItemHazmatSuitArmor(Type.BOOTS, props))
   );
   public static final ItemRegistryObject<ItemMekaSuitArmor> MEKASUIT_HELMET = ITEMS.registerUnburnable(
      "mekasuit_helmet", props -> new ItemMekaSuitArmor(Type.HELMET, props)
   );
   public static final ItemRegistryObject<ItemMekaSuitArmor> MEKASUIT_BODYARMOR = ITEMS.registerUnburnable(
      "mekasuit_bodyarmor", props -> new ItemMekaSuitArmor(Type.CHESTPLATE, props)
   );
   public static final ItemRegistryObject<ItemMekaSuitArmor> MEKASUIT_PANTS = ITEMS.registerUnburnable(
      "mekasuit_pants", props -> new ItemMekaSuitArmor(Type.LEGGINGS, props)
   );
   public static final ItemRegistryObject<ItemMekaSuitArmor> MEKASUIT_BOOTS = ITEMS.registerUnburnable(
      "mekasuit_boots", props -> new ItemMekaSuitArmor(Type.BOOTS, props)
   );
   ...
   public static final ItemRegistryObject<Item> REFINED_GLOWSTONE_INGOT = ITEMS.register(
      ResourceType.INGOT.getRegistryPrefix() + "_" + MiscResource.REFINED_GLOWSTONE.getRegistrySuffix(), ItemRefinedGlowstoneIngot::new
   );
   ...
   private static ItemRegistryObject<Item> registerCircuit(BaseTier tier) {
      return ITEMS.register(tier.getLowerName() + "_control_circuit", (Function<Properties, Item>)(properties -> new Item(properties) {
         @NotNull
         public Component m_7626_(@NotNull ItemStack stack) {
            return TextComponentUtil.build(tier.getColor(), super.m_7626_(stack));
         }
      }));
   }
   ...
   private static ItemRegistryObject<ItemTierInstaller> registerInstaller(@Nullable BaseTier fromTier, @NotNull BaseTier toTier) {
      return ITEMS.register(
         toTier.getLowerName() + "_tier_installer",
         (Function<Properties, ItemTierInstaller>)(properties -> new ItemTierInstaller(fromTier, toTier, properties))
      );
   }

   private static ItemRegistryObject<ItemAlloy> registerAlloy(AlloyTier tier, Rarity rarity) {
      return ITEMS.register("alloy_" + tier.getName(), (Function<Properties, ItemAlloy>)(properties -> new ItemAlloy(tier, properties.m_41497_(rarity))));
   }

   private static ItemRegistryObject<ItemUpgrade> registerUpgrade(Upgrade type) {
      return ITEMS.register("upgrade_" + type.getRawName(), (Function<Properties, ItemUpgrade>)(properties -> new ItemUpgrade(type, properties)));
   }

   private static ItemRegistryObject<ItemQIODrive> registerQIODrive(QIODriveTier tier) {
      return ITEMS.register(
         "qio_drive_" + tier.name().toLowerCase(Locale.ROOT), (Function<Properties, ItemQIODrive>)(properties -> new ItemQIODrive(tier, properties))
      );
   }
