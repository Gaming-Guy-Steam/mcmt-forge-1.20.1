...
public enum FactoryType implements IHasTranslationKey {
   ...
   private FactoryType(
      String registryNameComponent, MekanismLang langEntry, Supplier<Machine.FactoryMachine<?>> baseMachine, Supplier<BlockRegistryObject<?, ?>> baseBlock
   ) {
   ...
   public String getRegistryNameComponentCapitalized() {
      String name = this.getRegistryNameComponent();
