...
public class CCCapabilityHelper {
   private static final Capability<IPeripheral> CAPABILITY = CapabilityManager.get(new CapabilityToken<IPeripheral>() {});
   ...
   public static <TILE extends BlockEntity & IComputerTile> ICapabilityResolver getComputerCraftCapability(TILE tile) {
      return tile.isComputerCapabilityPersistent()
         ? BasicCapabilityResolver.persistent(CAPABILITY, () -> MekanismPeripheral.create(tile))
         : BasicCapabilityResolver.create(CAPABILITY, () -> MekanismPeripheral.create(tile));
   }
