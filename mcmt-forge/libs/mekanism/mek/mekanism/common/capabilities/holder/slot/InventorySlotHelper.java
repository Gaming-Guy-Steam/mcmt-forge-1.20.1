...
public class InventorySlotHelper {
   ...
   public static InventorySlotHelper forSide(
   ...
   public <SLOT extends IInventorySlot> SLOT addSlot(@NotNull SLOT slot) {
      if (this.built) {
         ...
         if (this.slotHolder instanceof InventorySlotHolder slotHolder) {
            slotHolder.addSlot(slot);
         } else if (this.slotHolder instanceof ReadOnlyInventorySlotHolder slotHolder) {
            slotHolder.addSlot(slot);
         } else {
            if (!(this.slotHolder instanceof ConfigInventorySlotHolder slotHolder)) {
   ...
   public <SLOT extends IInventorySlot> SLOT addSlot(@NotNull SLOT slot, RelativeSide... sides) {
      if (this.built) {
         throw new IllegalStateException("Builder has already built.");
      } else if (this.slotHolder instanceof InventorySlotHolder slotHolder) {
