...
public class ProxiedFluidTankHolder extends ProxiedHolder implements IFluidTankHolder {
   ...
   public static ProxiedFluidTankHolder create(
      Predicate<Direction> insertPredicate, Predicate<Direction> extractPredicate, Function<Direction, List<IExtendedFluidTank>> tankFunction
   ) {
      return new ProxiedFluidTankHolder(insertPredicate, extractPredicate, tankFunction);
   }

   private ProxiedFluidTankHolder(
      Predicate<Direction> insertPredicate, Predicate<Direction> extractPredicate, Function<Direction, List<IExtendedFluidTank>> tankFunction
   ) {
