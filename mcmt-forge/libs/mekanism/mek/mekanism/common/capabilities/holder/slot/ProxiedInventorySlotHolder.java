...
public class ProxiedInventorySlotHolder extends ProxiedHolder implements IInventorySlotHolder {
   ...
   public static ProxiedInventorySlotHolder create(
      Predicate<Direction> insertPredicate, Predicate<Direction> extractPredicate, Function<Direction, List<IInventorySlot>> slotFunction
   ) {
      return new ProxiedInventorySlotHolder(insertPredicate, extractPredicate, slotFunction);
   }

   private ProxiedInventorySlotHolder(
      Predicate<Direction> insertPredicate, Predicate<Direction> extractPredicate, Function<Direction, List<IInventorySlot>> slotFunction
   ) {
   ...
   public List<IInventorySlot> getInventorySlots(@Nullable Direction side) {
      return this.slotFunction.apply(side);
   }
}
