...
public class RateLimitInfusionHandler extends ItemStackMekanismInfusionHandler {
   ...
   public static RateLimitInfusionHandler create(LongSupplier rate, LongSupplier capacity) {
      return create(
         rate, capacity, ChemicalTankBuilder.INFUSION.alwaysTrueBi, ChemicalTankBuilder.INFUSION.alwaysTrueBi, ChemicalTankBuilder.INFUSION.alwaysTrue
      );
   }

   public static RateLimitInfusionHandler create(
      LongSupplier rate,
      ...
      return new RateLimitInfusionHandler(listener -> new RateLimitChemicalTank.RateLimitInfusionTank(rate, capacity, canExtract, canInsert, isValid, listener));
   }
