...
public class RateLimitSlurryHandler extends ItemStackMekanismSlurryHandler {
   ...
   public static RateLimitSlurryHandler create(
      LongSupplier rate,
      ...
      return new RateLimitSlurryHandler(listener -> new RateLimitChemicalTank.RateLimitSlurryTank(rate, capacity, canExtract, canInsert, isValid, listener));
   }
