...
public class RateLimitPigmentHandler extends ItemStackMekanismPigmentHandler {
   ...
   public static RateLimitPigmentHandler create(
      LongSupplier rate,
      ...
      return new RateLimitPigmentHandler(listener -> new RateLimitChemicalTank.RateLimitPigmentTank(rate, capacity, canExtract, canInsert, isValid, listener));
   }
