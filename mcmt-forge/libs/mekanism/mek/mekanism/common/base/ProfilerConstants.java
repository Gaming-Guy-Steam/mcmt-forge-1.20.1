...
public class ProfilerConstants {
   ...
   public static final String ENERGY_CUBE_CORE = "energyCube.core";
   public static final String SPS_CORE = "supercriticalPhaseShifter.core";
   public static final String SPS_ORBIT = "supercriticalPhaseShifter.orbitEffect";
