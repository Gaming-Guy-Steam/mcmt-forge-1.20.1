...
public final class TextUtils {
   ...
   public static Component getPercent(double ratio) {
      return MekanismLang.GENERIC_PERCENT.translate(new Object[]{Math.round(ratio * 100.0)});
   }
   ...
   public static Component getHoursMinutes(int seconds) {
      ...
      return hours > 0
         ? MekanismLang.GENERIC_HOURS_MINUTES.translate(new Object[]{hours, minutes % 60})
         : MekanismLang.GENERIC_MINUTES.translate(new Object[]{minutes});
   }
   ...
   public static String hex(boolean prefix, int bytes, long value) {
      ...
      for (int i = 0; i < bytes * 2; i++) {
         ret.insert(0, HEX_CODES[(int)(value & 15L)]);
         value >>= 4;
      }
