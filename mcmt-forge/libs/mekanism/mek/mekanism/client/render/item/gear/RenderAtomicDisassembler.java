...
public class RenderAtomicDisassembler extends MekanismISTER {
   ...
   public void m_6213_(@NotNull ResourceManager resourceManager) {
      this.atomicDisassembler = new ModelAtomicDisassembler(this.getEntityModels());
   }
   ...
   public void m_108829_(
      ...
      this.atomicDisassembler.render(matrix, renderer, light, overlayLight, stack.m_41790_());
      matrix.m_85849_();
   }
}
