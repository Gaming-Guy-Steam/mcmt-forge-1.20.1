...
public class GuiDynamicTank extends GuiMekanismTile<TileEntityDynamicTank, MekanismTileContainer<TileEntityDynamicTank>> {
   ...
   protected void addGuiElements() {
      ...
      this.addRenderableWidget(new GuiInnerScreen(this, 49, 21, 84, 46, () -> {
         List<Component> ret = new ArrayList<>();
         TankMultiblockData multiblock = this.tile.getMultiblock();
         long capacity = multiblock.getChemicalTankCapacity();
         switch (multiblock.mergedTank.getCurrentType()) {
            case EMPTY:
               ret.add(MekanismLang.EMPTY.translate(new Object[0]));
               break;
            case FLUID:
         ...
         ret.add(MekanismLang.CAPACITY.translate(new Object[]{""}));
         ret.add(MekanismLang.GENERIC_MB.translate(new Object[]{TextUtils.format(capacity)}));
         return ret;
      }).spacing(2));
      ...
      this.addRenderableWidget(
         new GuiMergedTankGauge(() -> this.tile.getMultiblock().mergedTank, this.tile::getMultiblock, GaugeType.MEDIUM, this, 7, 16, 34, 56)
      );
   }
   ...
   private <STACK> void addStored(List<Component> ret, STACK stack, ToLongFunction<STACK> amountGetter) {
      ret.add(MekanismLang.GENERIC_PRE_COLON.translate(new Object[]{stack}));
      ret.add(MekanismLang.GENERIC_MB.translate(new Object[]{TextUtils.format(amountGetter.applyAsLong(stack))}));
   }
