...
public class GuiBoilerTab extends GuiTabElementType<TileEntityBoilerCasing, GuiBoilerTab.BoilerTab> {
   public GuiBoilerTab(IGuiWrapper gui, TileEntityBoilerCasing tile, GuiBoilerTab.BoilerTab type) {
      super(gui, tile, type);
   }
   ...
   public static enum BoilerTab implements TabType<TileEntityBoilerCasing> {
      ...
      private BoilerTab(String path, ILangEntry description, PacketGuiButtonPress.ClickedTileButton button, ColorAtlas.ColorRegistryObject colorRO) {
         this.path = path;
